...
def build_preview_prompt(match: dict) -> str:
    ...
    return (
        ...
        f"[SCENE:opener] — Fire-up: announce this match with immense theatrical gravitas, its championship magnitude, and why tonight matters.\n"
...
def build_pregame_prompt(match: dict) -> str:
    ...
    return (
        ...
        f"[SCENE:opener] — Fire-up: announce this clash with immense theatrical gravitas and its championship magnitude.\n"
